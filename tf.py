...
def tf(fichier):
    ...
    with open(fichier,"r", encoding = 'utf-8') as file: # On ouvre le fichier en mode lecture
        texte = file.read() # La variable texte est une chaine de caractère contenat le contenu du fichier file
